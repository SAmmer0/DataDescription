...
dd = DataDescription(mkv_factory('TOTAL_SHARES', 'CLOSE'), trans_date('2018-05-14'),
                     DataType.PANEL_NUMERIC, dep=['CLOSE', 'TOTAL_SHARES', 'LIST_STATE'],
                     desc='总市值（由收盘价计算）')
